...
| AT-04 | Readiness, prepared dependencies and role settings | in_progress | P1 | root + installation_review | AT-02 | Core9ed9b115 accepted/integrated; final scope audit found upstream Playwright workspace installer overwrites/escapes user scope and reused CLI skips companion checks; scoped repair in .worktrees/playwright-companion. Initializer945d235 accepted59/59; setupCLI follow-up being repaired/re-reviewed |
...
| AT-07 | Cross-host integration and release qualification | in_progress | P1 | root | AT-01, AT-02, AT-03, AT-04, AT-05, AT-06 | CLI05b67c5/graph5b61072/initializer945d235 accepted and integrated; rootlatestdocs/package/initializer64/64; new actualCLIjourney + installedZIPsetup/status matrix awaits finalsetupCLI; realbd1/1 and updatedguide/static/livebrowser pass; native/mandatoryCLI gates remain |
...
- SetupCLI independent follow-up found an invalid outage fixture (Markdown setup rewritten to Beads). Installation worker is replacing it with actual existing-Beads initialization and testing original-tracker binding; user-scope readiness, run capacity/scope and fresh locked ownership fixes already implemented.
...
- AT-05: .worktrees/dashboard/be4575e and .worktrees/installation/5b61072 clean idle, accepted/merged. Initializer .worktrees/initialization/945d235 accepted/merged. Installation_implementation owns final setupCLI follow-up in .worktrees/setup-cli; installation_review owns dependencies-only repair in .worktrees/playwright-companion. Readiness_implementation reviews separately; root owns all integration wiring/manifests/docs.
