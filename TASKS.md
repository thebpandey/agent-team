...
| AT-05 | Compact status and optional web dashboard | integrated | P2 | root | AT-01, AT-03, AT-04 | be4575e base27/27 and graph5b61072 review38/38 accepted; CLI/manifest/opt-in automatic snapshot producers integrated; current actual static/mobile/live browser passed. Graph remains fixture-qualified, not actual bv execution |
| AT-06 | Skill instructions, context efficiency and usage evidence | in_progress | P1 | root | AT-01, AT-03, AT-04 | Guides/conditional instructions and CLI producers integrated at2060e7e; fresh native hosts read7.0.0. Observed discovery usage retained, not a matched benchmark; native all-role/compaction metrics remain |
| AT-07 | Cross-host integration and release qualification | in_progress | P1 | root | AT-01, AT-02, AT-03, AT-04, AT-05, AT-06 | Integration2060e7e clean; full465/465 zero skips with real dependencies, selectedbd and user-approved node-e. Source/ZIP12-case CLI matrix, package and duplicate archive checks pass. Real Playwright0.1.19 complete scoped browser journey/close passed. Native discovery and scoped Codex trust completed; full native lifecycle/worker/recovery/benchmark gates remain |
| AT-08 | User documentation and GitHub delivery | in_progress | P1 | root | AT-07 | Guide/protocol WIP preserved and committed2060e7e; independent HTML/source review access restored and accepted. Exact candidate archives reproducible/validated; version7.0.0 unpublished. No main merge/push/tag/release; remote main rechecked6feb76a |
...
- Native Codex0.153.4/Claude2.1.266 discovered project7.0.0. Claude SessionStart/PreToolUse/PostToolBatch and Codex SessionStart/PreToolUse observed; native trust granted only to the reviewed Codex fixture/five hooks. Subsequent native Codex health ctx_shell was refused under never-approval policy; exact tool approval is pending. No denial reroute. Full native journeys, worker capabilities, compaction/recovery and matched metrics remain open.
