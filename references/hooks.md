...
| 11. Recurring cost | Advisory | Use a heuristic warning when changed content contains a schedule and differs from prior content. Confirm whether the schedule itself changed. Report unknown live pricing as unknown. |
