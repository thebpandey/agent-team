...
Help displays each available agent's Matrix name, role, and explanation: Morpheus (project/team orchestrator), Neo (complex developer), Trinity (standard developer and UI/UX developer), Tank (routine developer), Agent Smith (code reviewer), and The Oracle (visual reviewer).
