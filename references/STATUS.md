...
Include the [lane](LANES.md) queue/current task, rotation and worker generation when present. Report logical lane occupancy separately from observed native development/reviewer capacity; unknown worker liveness remains occupied and missing host inventory stays unknown.
