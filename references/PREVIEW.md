...
Approval permits that feature version to enter integration. It does not directly deploy it, grant a new production destination, waive project checks, or approve other teams. Notify the active project orchestrator or leave an acknowledged handoff; do not start a competing integration writer. Keep unrelated teams working.
