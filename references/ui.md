...
Load only for UI/UX tasks. Require Impeccable for Astra and every involved teammate. Preserve approved design systems. For new systems, establish audience, primary user job, brand constraints, visual direction, and representative content before decoration. Ask only about material unresolved decisions; do not restart discovery for known facts.
...
2. Use applicable Impeccable planning/build guidance. For broad new designs, optionally consult UI UX Pro Max for a targeted palette, typography, pattern, or stack recommendation. Do not load its entire library or create a competing system. Avoid stacking aesthetic skills without a specific unresolved need.
...
| --- | --- | --- |
| [Impeccable](https://github.com/pbakaus/impeccable) | Required default: product/design context, direction, responsive adaptation, critique, refinement; use relevant commands only | Apache-2.0; 65.6k |
