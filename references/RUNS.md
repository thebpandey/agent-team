...
Open lanes reserve logical development capacity between queued tasks; see [lanes](LANES.md). Count native worker and reviewer capacity separately, retain unknown occupancy, and reserve an independent reviewer slot before another lane admission.
