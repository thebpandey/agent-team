...
- Let fresh native-owner integration evidence clear only the hold created by a still-valid legacy-owner adoption receipt; missing, malformed, stale, mismatched, and ordinary holds remain in force.
