...
export const DEPENDENCY_CATALOG = Object.freeze([
  ...
  {
    id: "serena", name: "Serena", disposition: "default", version: "1.7.0", prerequisites: ["uv"],
    ...
    boundary: "Host MCP registration and reload are reported separately; they do not block tasks that do not require Serena.",
    functionalCheck: "symbol-operation",
  },
  {
    id: "playwright-cli", name: "Microsoft Playwright CLI", disposition: "default", version: "0.1.19", prerequisites: [],
    install: npm("@playwright/cli", "0.1.19", "playwright-cli"),
    preparation: ["inspect-help", "install-skills", "install-browser"],
    boundary: "Qualify this exact CLI; host browser adapters and Node REPL module loading are separate capabilities.",
