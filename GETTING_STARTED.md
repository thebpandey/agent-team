...
Use the published [Agent-Team 8.0.14](https://github.com/thebpandey/agent-team/releases/tag/v8.0.14) package. It handles bd 1.2.2 expanded dependency issue projections while keeping relation identity and types strict. The [release readiness record](docs/releases/8.0.14-readiness.md) records the successful workflow, managed Linux update, and read-only acceptance against a real bd 1.2.2 project.
