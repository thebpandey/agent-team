...
Only the orchestrator integrates, makes the integration commit, and closes a task. Its closure reason must identify the reviewed revision and integrated revision. It may remove a task worktree and delete its branch only after recording that the worktree is clean and its branch is merged; retain dirty, unmerged, unknown, or failed worktrees/branches without force removal.
