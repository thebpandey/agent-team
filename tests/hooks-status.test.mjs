...
test("status separates loaded runtime source candidate handoff and readiness", () => {
  const model = createStatusModel(project, effectiveCanonical(), {
    ...
    observedSourceCandidate: { status: "current", version: "7.2.2", authoritative: false },
  ...
  assert.deepEqual(model.provenance.sourceCandidate, { status: "current", version: "7.2.2", authoritative: false });
